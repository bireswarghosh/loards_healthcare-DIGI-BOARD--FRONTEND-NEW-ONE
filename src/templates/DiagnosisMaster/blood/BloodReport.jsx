...
import { handlePrint } from "./blood_report_pdf_genarator";
...
const BloodReport = () => {
  ...
  //   AdEosCount: 0, // not sure
  //   Basophils: 0,
  //   BleedTimeMin: 0,
  //   BleedTimeSec: 0,
  //   BloodGroup: null, // where to connect
  //   BloodId: "004517/24-25", // where to connect

  //   CaseId: "005656/24-25", // where to connect
  //   CoagulMin: 0,
  //   CoagulSec: 0,
  //   CorrectedWBCCount: 0,
  ...
  //   RDWUnit: "",
  //   Remarks: "",
  //   ReportDt: "2024-11-07T00:00:00.000Z",
  //   ReportTime: "02:09:00 AM",
  //   ReticulocyCount: 0,
  //   RHType: null, // where to connect
...
const [remarksSuggest, setRemarksSuggest] = useState([])
  ...
  const fetchBloodFormat = async () => {
    try {
      // console.log("id",id)
// console.log("mode",mode)
      // id = "005651/24-25";
      // const finalId = id;
      const finalId = decodeURIComponent(id)
console.log("id huu: ",finalId)
      if (!finalId) {
      ...
      const res = await axiosInstance.get(
        `/bloodformat/case/${finalId}?page=1&limit=20/`
      );
      ...
      if (res.data.success) {
        ...
        if (caseId) {
          ...
          if (res.data.success) {
            console.log("case data: ", res.data.data);
            setCaseData(res.data.data);
            setCaseNO(res.data.data.CaseNo);
            setData((prev) => ({
              ...prev,
              ...res.data.data,
            }));
      ...
      console.log("Error fetching blood format: ", error);
    }
  };
          ...
          <div className="counts-grid">
            ...
            >
              ...
              <div className="group-border" style={{ flex: 1 }}>
                ...
                {/* {console.log("remarks: ",remarksSuggest)} */}
                {
