...
//! store selected pathologist in local storage in LabrotaryQuery.jsx
...
const fetchPathologist = async () => {
  try {
    ...
    const pathologists = res?.data?.data || [];
    console.log("pathologists", pathologists);
    setPathologists(pathologists);
   
  } catch (error) {
    setPathologists([]);
    console.log("Error fetching pathologist list: ", error);
  }
}
          ...
          <div className='d-flex align-items-center gap-2 mb-1 flex-wrap'>
            ...
            <div className='d-flex align-items-center gap-2 ms-auto'>
              ...
              <select
                ...
                onChange={(e) => {
                  if(e.target.value == ""){  
                    ...
                    setSelPath(pathologists.find((p) => p.PathologistId == e.target.value) || {});
                    console.log("selected signatory id:", e.target.value);
              ...
              >
                <option value="">---</option>
                {pathologists.map((p) => (
                  <option key={p.PathologistId} value={p.PathologistId}>
                    {p.Pathologist}
                  </option>
                ))}
              </select>
