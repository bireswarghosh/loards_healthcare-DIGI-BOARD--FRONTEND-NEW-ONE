...
const CaseTestDataModal = ({
  ...
  const buildPatientHeaderHtml = () => {
    ...
    const addr = [formData2?.Add1, formData2?.Add2, formData2?.Add3].filter(Boolean).join(", ");
    const bDate = new Date().toISOString().split("T")[0];
    return `<div style="text-align:right;margin-bottom:4px"><img src="${barcodeImg}" style="height:45px" /></div><table style="width:100%;border:1px solid #000;border-collapse:collapse;font-size:14px;font-weight:bold;margin-bottom:8px"><tr><td style="padding:4px 6px;width:13%;border:none"><b>Patient</b></td><td style="padding:4px 6px;width:37%;border:none">: ${pName}</td><td style="padding:4px 6px;width:13%;border:none"><b>Age</b></td><td style="padding:4px 6px;width:37%;border:none">: ${age}</td></tr><tr><td style="padding:4px 6px;border:none"><b>Case No</b></td><td style="padding:4px 6px;border:none">: ${cNo}</td><td style="padding:4px 6px;border:none"><b>Sex</b></td><td style="padding:4px 6px;border:none">: ${sex}</td></tr><tr><td style="padding:4px 6px;border:none"><b>Ref. By</b></td><td style="padding:4px 6px;border:none">: </td><td style="padding:4px 6px;border:none"><b>Billing Date</b></td><td style="padding:4px 6px;border:none">: ${bDate}</td></tr><tr><td style="padding:4px 6px;border:none"><b>Address</b></td><td style="padding:4px 6px;border:none">: ${addr}</td><td style="padding:4px 6px;border:none"><b>Report Date</b></td><td style="padding:4px 6px;border:none">: </td></tr></table><hr style="border:none;border-top:2px solid #000;margin:8px 0" />`;
  };
