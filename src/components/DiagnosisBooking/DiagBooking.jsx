...
const DiagBooking = () => {
  ...
  const submitBookingDtlForm = async (e) => {
    ...
    try {
      if (modalType === "add") {
        ...
        // setFormData((prev) => ({
        //   ...prev,
        //   Total: (Number(prev.Total) + Number(bookingDtlForm.Rate)).toFixed(2),
        // }));
        // const response_formData = await axiosInstance.put(
        //   `/bookings/${id}`,
        //   formData
        // );
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axiosInstance.put(`/bookings/${id}`, formData);
  ...
  useEffect(() => {
    ...
    if (id) {
      ...
      // console.log("OPD changed", selectedTestOPD.value);
    }
  }, [selectedTestOPD]);
  ...
  // useEffect(() => {
  //   console.log("Booking Dtl Form changed: ", bookingDtlForm);
  // }, [bookingDtlForm]);
          ...
          <div className="col-md-8">
            ...
            >
              ...
              >
                ...
                {bookingDtlMap.length === 0 ? (
                  <tbody>
                    <td>No data available</td>
                  </tbody>
                ) : (
                  <tbody>
                    {bookingDtlMap.map((bookingDtl, idx) => (
                      <tr key={idx}>
                        {mode !== "view" && (
                          <td>
