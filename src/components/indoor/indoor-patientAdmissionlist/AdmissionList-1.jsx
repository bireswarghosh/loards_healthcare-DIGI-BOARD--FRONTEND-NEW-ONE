...
const AdmissionList = () => {
  ...
  // ✅ Consistency fix applied here as well
        ...
        <tr key={i}>
          <td>
            ...
            <button
              ...
              onClick={
                () =>
                  // ✅ FIX: Changed to /patient-registration/ to match other navigation
                  navigate(
                    `/patient-registration/${admission.AdmitionId}?mode=view`
                  )
              }
            >
              View
      ...
      <div className="panel-footer d-flex justify-content-between flex-wrap gap-2 p-3">
        <div className="btn-group">
          <button
            ...
            // ✅ Consistency: New button navigating to the correct base path
            onClick={() => navigate("/patient-registration/new?mode=create")}
          >
            New
          </button>
