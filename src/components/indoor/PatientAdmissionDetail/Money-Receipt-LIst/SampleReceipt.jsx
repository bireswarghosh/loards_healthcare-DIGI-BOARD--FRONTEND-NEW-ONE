  ...
  return (
    <div className="panel">
      ...
      <div className="panel-header">
        <div className="panel-title fw-bold">Sample Receipt</div>
                  ...
                  <tr key={index}>
                    <td>
                      <button
                        ...
                        onClick={() =>
                          navigate(
                            `/initialFormData/${receipt.MoneyreeciptId}?mode=view`
                          )
                        }
                      >
                        View
                      ...
                      <button
                        ...
                        onClick={() =>
                          navigate(
                            `/initialFormData/${receipt.MoneyreeciptId}?mode=edit`
                          )
                        }
                      >
                        Edit
