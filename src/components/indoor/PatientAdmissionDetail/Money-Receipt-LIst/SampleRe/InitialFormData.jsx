                ...
                <div className={`alert ${isFormLocked ? "alert-danger pulsing-warning-lock" : "alert-success"} shadow-lg border p-3 mb-4 d-flex align-items-center justify-content-between`} style={{
                  ...
                  <div className="d-flex align-items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="mb-0 small" style={{ opacity: 0.9 }}>
                        {isFormLocked 
                          ? "CRITICAL WARNING: Tampering with or altering money receipts is a high-risk financial audit violation. All unlocks are logged and fingerprinted."
                  ...
                  {isFormLocked && (
                    <button 
                      ...
                      style={{ background: 'linear-gradient(135deg, #d32f2f, #c62828)', border: 'none', borderRadius: '20px', letterSpacing: '0.5px' }}
            ...
            <div className="modal-dialog modal-dialog-centered">
              <div className="modal-content shadow-lg border-0" style={{
                ...
                <div className="p-4 text-white text-center position-relative" style={{
                  ...
                  <div className="small opacity-75 fw-bold" style={{ color: "#ffc107" }}>UNAUTHORIZED MONEY RECEIPT ALTERATION INFRINGEMENT</div>
                </div>
                ...
                <div className="p-4 text-white">
                  <div className="alert alert-danger border-0 p-3 mb-4 rounded-3 text-start" style={{ backgroundColor: "#3a0909", color: "#f8d7da" }}>
                    ...
                    <strong>CRITICAL DANGER WARNING:</strong> complete money receipts constitute legally binding medical transaction records. Altering or modifying a completed receipt without validated corporate clearance is flagged as financial fraud. Under strict regulatory audit protocols:
                  ...
                  <textarea
                    ...
                    rows="4"
                    placeholder="Enter precise operational reason (e.g., 'Corrected payment type from Bank to Cash as per cashier ledger verification'). MUST be at least 15 characters."
                    ...
                    onClick={async () => {
                      try {
                        ...
                        await axiosInstance.post("/activity-log", {
                          ...
                          action: "edit_receipt_unlock",
                          page: `/initialFormData/${id}?mode=edit`,
                          details: `Unlocked Money Receipt #${receiptData.MoneyreeciptNo || id} (Amount: ₹${receiptData.Amount || '0'}) for editing. Reason: ${unlockReason}`
                        });
