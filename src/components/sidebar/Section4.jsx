...
const Section4 = () => {
  ...
  if (!isSuperAdmin && permissions?.diagReport === false) {
    return null;
  }
  ...
  return (
    <li className="sidebar-item" ref={layoutPosition.horizontal ? mainSection4Ref : null}>
      ...
      <ul className={`sidebar-link-group ${layoutPosition.horizontal ? (dropdownOpen.section4 ? 'd-block' : '') : (isMainDropdownOpen ? 'd-none' : '')}`}>
        ...
        {(isSuperAdmin || permissions?.diagReport_patientId !== false) && (
        ...
        {(isSuperAdmin || permissions?.diagReport_testSchedule !== false) && (
          <li className="sidebar-dropdown-item">
        ...
        {(isSuperAdmin || permissions?.diagReport_caseWiseLab !== false) && (
          <li className="sidebar-dropdown-item">
        ...
        {(isSuperAdmin || permissions?.diagReport_doctorList !== false) && (
          <li className="sidebar-dropdown-item">
        ...
        {(isSuperAdmin || permissions?.diagReport_monthlyBill !== false) && (
          <li className="sidebar-dropdown-item">
        ...
        {(isSuperAdmin || permissions?.diagReport_cancelTest !== false) && (
          <li className="sidebar-dropdown-item">
        ...
        {(isSuperAdmin || permissions?.diagReport_deptWiseTest !== false) && (
          <li className="sidebar-dropdown-item">
        ...
        {(isSuperAdmin || permissions?.diagReport_agentWiseSale !== false) && (
          <li className="sidebar-dropdown-item">
