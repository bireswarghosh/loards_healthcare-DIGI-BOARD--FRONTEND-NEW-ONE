...
const AccessControl = () => {
  ...
  const [permissions, setPermissions] = useState({
    ...
    indoor_otBillingDetail: true,
    indoor_otNoteProcedure: true,
    indoor_doctorVisit: true,
    indoor_bedTransfer: true,
    indoor_estimate: true,
    indoor_dischargeAdvise: true,
    indoor_dischargeAndAdvise: true,
    indoor_advise: true,
    indoor_dischargeMrd: true,
    indoor_finalBillQuery: true,
    indoor_finalBillingDetail: true,
    indoor_finalBillingList: true,
    indoor_patientEnquiry: true,
    indoorMaster: true,
    indoorReport: true,
    diagnosis: true,
  ...
  const handlePermissionChange = (section) => {
    setPermissions(prev => {
      ...
      // Cascade down recursively: turn off all children & grandchildren
      if (!targetVal) {
